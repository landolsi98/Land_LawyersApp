...
VerticalLayout verticalLayout = new VerticalLayout();
    ...
    vaadinIcon.getElement().getStyle().setColor("darkblue");
        ...
        Paragraph description = new Paragraph("if you are facing serious charges.it is imperative that you seek assistance from a knoledgeable criminal defense lawyer as as possible.An experienced attorney can guide you through the legal process.explain your options.");
